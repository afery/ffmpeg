...
//#if !CONFIG_FLOAT
const static enum AVSampleFormat mp3_sample_formats[3]={ AV_SAMPLE_FMT_S16P, AV_SAMPLE_FMT_S16, AV_SAMPLE_FMT_NONE };
const static enum AVSampleFormat mp3on4_sample_formats[2]={ AV_SAMPLE_FMT_S16P, AV_SAMPLE_FMT_NONE };
...
AVCodec ff_mp1_decoder = {
    ...
    .sample_fmts    = mp3_sample_formats, /*(const enum AVSampleFormat[]) { AV_SAMPLE_FMT_S16P,
                                                      AV_SAMPLE_FMT_S16,
                                                      AV_SAMPLE_FMT_NONE },*/
};
#endif
...
AVCodec ff_mp3on4_decoder = {
    ...
    .sample_fmts    = mp3on4_sample_formats,/*(const enum AVSampleFormat[]) { AV_SAMPLE_FMT_S16P,
                                                      AV_SAMPLE_FMT_NONE },*/
};
#endif
//#endif //#if !CONFIG_FLOAT
